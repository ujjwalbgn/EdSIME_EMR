...
<div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="/ehr" class="brand-link">
            <img src={{asset("/img/logo.png")}} alt="EdSime Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
            <span class="brand-text font-weight-light">EdSIME EHR</span>
        </a>
