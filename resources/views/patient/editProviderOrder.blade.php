                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title">Lab Results for <strong>{{$patient->name}}</strong></h6>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="/providerOrder/{{$providerOrder->id}}">
                                ...
                                <textarea name="content" class="form-control TinyMCE-editor">{!! old('content', $providerOrder->content) !!}</textarea>
                                <div class="mt-2">
