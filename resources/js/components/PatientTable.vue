<template>
    <div class="container mt-5" v-if="$gate.isAdminOrAuthor()">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="/barcode/patient" class="btn btn-success">Print Barcode <i class="fas fa-barcode"></i></a>
                        </div>
                    </div>
                    ...
                    if(result.value){
                        this.form.delete('api/patient/'+id).then(()=>{
                            ...
                            toast.fire({
                                type: 'error',
                                title: 'Oops...',
                                text: 'Something went wrong! Unable to Delete Patient Make your all Medications have been removed from Pateint`s Mar'
                            })
                            this.$Progress.fail();
                        })
                    }
